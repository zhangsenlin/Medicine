package com.example.medicine.chat;
...
public class ChatMessageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			...
			{
				convertView = mInflater.inflate(R.drawable.item_from_msg, parent,
						false);
			...
			{
				convertView = mInflater.inflate(R.drawable.item_to_msg, parent,
						false);
				viewHolder = new ViewHolder();
				viewHolder.mDate = (TextView) convertView
